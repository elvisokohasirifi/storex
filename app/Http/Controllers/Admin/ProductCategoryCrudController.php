...
class ProductCategoryCrudController extends CrudController
{
    ...
    public function setup(): void
    {
        ...
        CRUD::setRoute(backpack_url('product-category'));
        ...
        if (backpack_user()->is_platform_admin) {
            ...
            $entry = ProductCategory::whereIn('shop_id', backpack_user()->accessibleShops()->select('shops.id'))->whereKey(request()->route('id'))->firstOrFail();
